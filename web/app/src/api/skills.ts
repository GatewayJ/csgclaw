...
function normalizeAgenticHubOfficialSkill(record: unknown, remoteSource: string): SkillSummary | null {
  return normalizeAgenticHubSkill(record, SKILL_SOURCE_OFFICIAL, remoteSource);
}

function normalizeAgenticHubSkill(record: unknown, source: string, remoteSource = ""): SkillSummary | null {
