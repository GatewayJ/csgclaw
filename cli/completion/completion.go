		...
		Children: []CommandSpec{
			...
			},
			{
				...
				Flags: append(feishuChannelFlags(),
					FlagSpec{Name: "subject", TakesValue: true, Values: []string{"human", "agent-app"}},
					FlagSpec{Name: "profile", TakesValue: true, Values: []string{"admin"}},
					FlagSpec{Name: "identity-kind", TakesValue: true, Values: []string{"open_id"}},
					FlagSpec{Name: "identity-ref", TakesValue: true},
					FlagSpec{Name: "agent-id", TakesValue: true},
					FlagSpec{Name: "app-ref", TakesValue: true},
					FlagSpec{Name: "apply"},
